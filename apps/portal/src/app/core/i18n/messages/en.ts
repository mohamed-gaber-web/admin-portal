...
export const en = {
  ...
  "createTenant.modulesDroppedTitle": "Some modules were not enabled",
  "createTenant.modulesDroppedBody": "This installation does not know these modules yet, so the tenant was created without them: {modules}. Apply the pending database migration, then enable them on the tenant’s profile.",
  "provisioning.firstRunTitle": "This tenant cannot reach Dynamics yet",
  "provisioning.firstRunBody": "A new tenant is created without an environment, so everyone in it is sent to the setup screen in the mobile app. Add the environment below, save its credentials on the connection card, then add at least one company — the app works from that point.",
  ...
  "provisioning.addEnvironment": "Add environment",
  "provisioning.addCompany": "Add company",
  "provisioning.environmentName": "Environment name",
  "provisioning.environmentNameHint": "How operators will recognise it, e.g. “Acme Production”.",
  "provisioning.environmentUrl": "Dynamics URL",
  "provisioning.environmentUrlHint": "The instance this tenant runs on. Must be https — ERP access tokens are sent to it.",
  "provisioning.environmentKind": "Kind",
  "provisioning.environmentKindHint": "Sandbox unless this is the customer’s live instance.",
  "provisioning.urlInvalid": "Enter an https:// address.",
  "provisioning.createEnvironment": "Create environment",
  "provisioning.environmentCreated": "Environment added.",
  "provisioning.environmentFailed": "The environment could not be created.",
  "provisioning.companyEnvironment": "Environment",
  "provisioning.companyEnvironmentHint": "Which environment this legal entity belongs to.",
  "provisioning.companyName": "Company name",
  "provisioning.dataAreaId": "Data area ID",
  "provisioning.dataAreaIdHint": "The D365 company code every query is scoped to, lowercase — e.g. usmf.",
  "provisioning.dataAreaIdInvalid": "Lowercase letters and digits only.",
  "provisioning.createCompany": "Create company",
  "provisioning.companyCreated": "Company added.",
  "provisioning.companyFailed": "The company could not be created.",
  "contract.ownTitle": "Your subscription",
  "contract.ownSubtitle": "The term your organisation is signed up for.",
  "contract.ownNoticeEnding": "Your subscription ends in {duration}. Your account stays open — nothing stops working on the end date. Contact your provider to renew.",
  "contract.ownNoticeExpired": "Your subscription ended {duration} ago. Your account is still open and nobody has been locked out. Contact your provider to renew.",
  "contract.ownExplainNone": "No term has been recorded for your organisation. Your account is open and everything works normally.",
  "contract.ownExplainUpcoming": "Your term has not begun yet. Your account is already open — you can sign in and use the modules you have now.",
  "contract.ownExplainActive": "Your subscription is running and your account is open. Everyone in your organisation can sign in and use the modules listed on this page.",
  "contract.ownExplainEnding": "Your term is nearly up. Your account stays open and nothing stops on the end date — contact your provider if you want to renew.",
  "contract.ownExplainExpired": "Your term has passed, and your account is still open: everyone can sign in and your modules still work. Nothing was cut off automatically. Contact your provider to renew.",
  "contract.title": "Contract",
  "contract.subtitle": "The term this customer has signed for.",
  "contract.startDate": "Start date",
  "contract.endDate": "End date",
  "contract.editHint": "Leave a date empty to clear it. An open-ended term is fine — record the start and leave the end blank.",
  "contract.endBeforeStart": "The contract cannot end before it starts.",
  "contract.saved": "Contract period updated.",
  "contract.failed": "The contract period could not be saved.",
  "contract.progressLabel": "Contract term elapsed",
  "contract.elapsed": "{percent}% of a {total}-day term elapsed",
  "contract.stateNone": "No contract recorded",
  "contract.stateUpcoming": "Starts in {days}",
  "contract.stateActive": "Active — {days} remaining",
  "contract.stateOpenEnded": "Active — no end date",
  "contract.stateExpiring": "Ending soon — {days} remaining",
  "contract.stateImminent": "Ends in {days}",
  "contract.stateExpired": "Expired {days} ago",
  "contract.explainNone": "No term has been recorded for this customer. The account is open and everything works normally — recording the dates only makes renewals visible here.",
  "contract.explainUpcoming": "The term has not begun yet. The account is already open: users can sign in and their modules work now, not from the start date.",
  "contract.explainActive": "The subscription is running and the account is open. Users can sign in and see the modules enabled below.",
  "contract.explainEnding": "The term is nearly up. The account stays open — nothing stops on the end date — so renew it here, or suspend the tenant on the lifecycle card if they are leaving.",
  "contract.explainExpired": "The term has passed, and the account is still open: users can sign in and their modules still work. Nothing was cut off automatically. Renew the dates here, or suspend the tenant on the lifecycle card.",
  "contract.weekCount.zero": "{count} weeks",
  "contract.weekCount.one": "{count} week",
  "contract.weekCount.two": "{count} weeks",
  "contract.weekCount.few": "{count} weeks",
  "contract.weekCount.many": "{count} weeks",
  "contract.weekCount.other": "{count} weeks",
  "contract.weeksAndDays": "{weeks} and {days}",
  "contract.noticeEnding": "This subscription ends in {duration}. The account stays open — nothing is cut off on the end date.",
  "contract.noticeExpired": "This subscription ended {duration} ago. The account is still open and nobody has been locked out.",
  "contract.dayCount.zero": "{count} days",
  "contract.dayCount.one": "{count} day",
  "contract.dayCount.two": "{count} days",
  "contract.dayCount.few": "{count} days",
  "contract.dayCount.many": "{count} days",
  "contract.dayCount.other": "{count} days",
  "modulePicker.count": "{selected} of {total} modules selected",
  "modulePicker.selectAll": "Select all",
  "modulePicker.clear": "Clear",
  "modulePicker.searchPlaceholder": "Filter modules",
  "modulePicker.searchLabel": "Filter modules by name",
  "modulePicker.groupLabel": "Modules",
  "modulePicker.noMatches": "No module matches “{query}”.",
  "modules.unsaved": "Unsaved changes",
  "modules.grantedCount": "{count} of {total} modules enabled",
  "modules.noneGranted": "No modules are enabled for this tenant. Their mobile menu will be empty.",
  "createTenant.modules": "Modules",
  "createTenant.modulesHint": "Which parts of the product this customer may use. These become the menu in the mobile app, and you can change them later on the tenant’s profile.",
  "module.inventory": "Inventory",
  "module.inventory.description": "Transfer orders, cycle counting and transfer journals.",
  "module.purchase-order": "Purchase order",
  "module.purchase-order.description": "Product receipts, registration, vendor returns and paper-PO scanning.",
  "module.sales-order": "Sales order",
  "module.sales-order.description": "Packing slips and inventory reservation.",
  "module.return-order": "Return order",
  "module.return-order.description": "Picking slips for customer returns.",
  "module.project": "Project",
  "module.project.description": "Item requirements and project item journals.",
  "module.production": "Production",
  "module.production.description": "Picking lists and report as finished.",
  "module.warehouse": "Warehouse",
  "module.warehouse.description": "License plates, pick and put, and packing.",
  "module.inquiry": "Inquiry",
  "module.inquiry.description": "On-hand lists and inventory inquiry.",
  "module.van-sales": "Van sales",
  "module.van-sales.description": "Mobile order capture and delivery on a route.",
  "module.route-tracking": "Route tracking",
  "module.route-tracking.description": "Journey plans, route management, GPS and dispatch.",
  "module.trade-payments": "Trade and payments",
  "module.trade-payments.description": "Promotions, merchandising, customer credit and e-payment.",
  "module.performance": "Performance",
  "module.performance.description": "KPIs, commission, dashboards and smart reports.",
  "module.distribution": "Distribution",
  "module.distribution.description": "Distributor management, supervisor app and ERP integration.",
